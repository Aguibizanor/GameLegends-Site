...
import morticia from '../assets/morticia.png';
import city from '../assets/city.png';
import gladia from '../assets/gladia.png';
...
const iOs = () => {
    ...
    useEffect(() => {
        ...
        fetch('/api/produtos?plataforma=ios')
            ...
            <main className="principal">
                ...
                <section className="games-section" style={{
                    ...
                    onMouseLeave={(e) => {
                        ...
                        <img src={morticia} alt="Mortician's Tale" style={{ width: isMobile ? '220px' : (isTablet ? '260px' : '320px'), height: isMobile ? '170px' : (isTablet ? '200px' : '320px'), objectFit: 'cover', borderRadius: '15px' }} />
                        <div style={{ margin: '15px 0', fontSize: '18px', fontWeight: 'bold' }}><a href="" style={{ color: 'black', textDecoration: 'none' }}>Mortician's Tale</a></div>
                        <button style={{
                    ...
                    onMouseLeave={(e) => {
                        ...
                        <img src={city} alt="CityGlitch" style={{ width: isMobile ? '180px' : (isTablet ? '220px' : '280px'), height: isMobile ? '140px' : (isTablet ? '170px' : '280px'), objectFit: 'cover', borderRadius: '15px' }} />
                        <div style={{ margin: '15px 0', fontSize: '18px', fontWeight: 'bold' }}><a href="" style={{ color: 'black', textDecoration: 'none' }}>CityGlitch</a></div>
                        <button style={{
                            backgroundColor: '#90017F',
                            color: 'white',
                            border: 'none',
                    ...
                    onMouseLeave={(e) => {
                        ...
                        <img src={gladia} alt="Gladiabots" style={{ width: isMobile ? '180px' : (isTablet ? '220px' : '280px'), height: isMobile ? '140px' : (isTablet ? '170px' : '280px'), objectFit: 'cover', borderRadius: '15px' }} />
                        <div style={{ margin: '15px 0', fontSize: '18px', fontWeight: 'bold' }}><a href="" style={{ color: 'black', textDecoration: 'none' }}>Gladiabots</a></div>
                        <button style={{
                            backgroundColor: '#90017F',
                            color: 'white',
                            border: 'none',
                    ...
                    onMouseLeave={(e) => {
                        ...
                        <img src={ceu} alt="Até a borda do Céu" style={{ width: isMobile ? '180px' : (isTablet ? '220px' : '280px'), height: isMobile ? '140px' : (isTablet ? '170px' : '280px'), objectFit: 'cover', borderRadius: '15px' }} />
                        <div style={{ margin: '15px 0', fontSize: '18px', fontWeight: 'bold' }}><a href="" style={{ color: 'black', textDecoration: 'none' }}>Até a borda do Céu</a></div>
                        <button style={{
                            backgroundColor: '#90017F',
                            color: 'white',
                            border: 'none',
                    ...
                    onMouseLeave={(e) => {
                        ...
                        <img src={sixit} alt="Sixit" style={{ width: isMobile ? '180px' : (isTablet ? '220px' : '280px'), height: isMobile ? '140px' : (isTablet ? '170px' : '280px'), objectFit: 'cover', borderRadius: '15px' }} />
                        <div style={{ margin: '15px 0', fontSize: '18px', fontWeight: 'bold' }}><a href="" style={{ color: 'black', textDecoration: 'none' }}>Sixit</a></div>
                        <button style={{
                            backgroundColor: '#90017F',
                            color: 'white',
                            border: 'none',
                    ...
                    onMouseLeave={(e) => {
                        ...
                        <img src={imost} alt="Inmost" style={{ width: isMobile ? '180px' : (isTablet ? '220px' : '280px'), height: isMobile ? '140px' : (isTablet ? '170px' : '280px'), objectFit: 'cover', borderRadius: '15px' }} />
