            ...
            <main className="principal">
                ...
                <section className="games-section" style={{
                    ...
                    onMouseLeave={(e) => {
                        ...
                        <img src={ourlife} alt="Our Life" style={{ width: isMobile ? '220px' : (isTablet ? '260px' : '320px'), height: isMobile ? '170px' : (isTablet ? '200px' : '320px'), objectFit: 'cover', borderRadius: '15px' }} />
