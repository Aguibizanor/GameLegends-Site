...
import insetin from '../assets/insetin.png';
import loom from '../assets/loom.png';
import endless from '../assets/endless.png';
import kamaeru from '../assets/kamaeru.png';
            ...
            <main className="principal">
                ...
                <section className="games-section" style={{
                    ...
                    onMouseLeave={(e) => {
                        ...
                        <img src={insetin} alt="Bug Fables" style={{ width: isMobile ? '220px' : (isTablet ? '260px' : '320px'), height: isMobile ? '170px' : (isTablet ? '200px' : '320px'), objectFit: 'cover', borderRadius: '15px' }} />
